...
// export type logType = 'silent' | 'fatal' | 'error' | 'warn' | 'log' | 'info' | 'success' | 'debug' | 'trace' | 'verbose' | 'ready' | 'start'
...
//   private _mockFn = null
//   private _throttle = null
//   private _throttleMin = null
//   private _lastLogSerialized = undefined
//   private _lastLog = undefined
//   private _lastLogTime = undefined
//   private _lastLogCount = undefined
//   private _throttleTimeout = undefined
