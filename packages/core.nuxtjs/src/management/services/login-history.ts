import { apiModels, paginationModels } from '#ustra/core/data'
...
export const useUstraLoginHistoryService = defineUstraService(({ api }) => {
  async function getLoginHistorys(data: LoginHistCriteria, option: ApiOriginOptions = {}, showLoadingBar: boolean = true) {
  ...
  async function getListHhChart(data: LoginHistCriteria, option: ApiOriginOptions = {}, showLoadingBar: boolean = true) {
    const res = await api.call<apiModels.ApiResponse<LoginHist[]>>({
      ...option,
  ...
  async function getCurrentAcc(data: LoginHistCriteria, option: ApiOriginOptions = {}, showLoadingBar: boolean = true) {
    const res = await api.call<apiModels.ApiResponse<LoginHist[]>>({
      ...option,
  ...
  async function getAccCnt(data: LoginHistCriteria, option: ApiOriginOptions = {}, showLoadingBar: boolean = true) {
    const res = await api.call<apiModels.ApiResponse<LoginHist[]>>({
      ...option,
  ...
  return { getLoginHistorys, getListHhChart, getCurrentAcc, getAccCnt, listDownload }
})
