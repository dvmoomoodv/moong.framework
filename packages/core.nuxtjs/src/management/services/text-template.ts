 ...
 * 텍스트 템플릿 서비스
 */
export const useUstraTextTemplateService = defineUstraService(({ $ustra, api }) => {
  /**
   * 텍스트 템플릿 목록 조회
  ...
  return { getTxtTmpls, getTxtTmpl, addTxtTmpl, updateTxtTmpl, deleteTxtTmpl, getTextTemplateEngineList, testTxtTmpl }
})
