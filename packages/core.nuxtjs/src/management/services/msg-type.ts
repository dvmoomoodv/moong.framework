...
import { MessageTypeCriteria, MessageType, MessageTypeProp } from '../models/msg-type'

/**
 * 메시지 유형 서비스
 */
export const useUstraMessageTypeService = defineUstraService(({ $ustra, api }) => {
  /**
   * 메시지 유형 조회
  ...
  return { getMsgTypes, getMsgType, addMsgType, updateMsgType, removeMsgType, getProviderList }
})
