...
import { jwt } from '#moong/core/utils'
...
export default (route, headers, event) => {
  ...
  nuxt.hook("nitro:config", (nitro) => {
    ...
    nitro.virtual["#moong-cache-ssr-options"] =
    ...
    nitro.virtual["#moong-cache-ssr-key-function"] =
      typeof key === "string" ? key : "export default undefined";
