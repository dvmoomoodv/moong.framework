 ...
 * @param nuxt
 */
async function registerCustomMenuIpAddressChecker(options: NuxtAppProps, nuxt: Nuxt) {
...
function registerComposableDirs(options: NuxtAppProps, nuxt: Nuxt) {
  ...
  nuxt.hook('imports:dirs', dirs => {
    dirs.push(resolveFrameworkModulePath('#ustra/nuxt/management/composables'))
    dirs.push(resolveFrameworkModulePath('#ustra/nuxt/management/composables/components'))
  })
}
