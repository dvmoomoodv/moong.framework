...
import { logger, useLogger } from '#ustra/nuxt/utils/logger'
import { core, date, system } from '#ustra/core/utils'
...
export class Ustra {
  ...
  async init() {
    ...
    logger.info(`😸 U.STRA framework version : ${this.env.appProps.app.version}`)
  ...
  private _interfaceStore: Awaited<ReturnType<typeof useUstraInterfaceStore>> = null
