...
<html class="default" lang="en">
  <head>
    ...
    <title>module/build/plugins/watch-node-modules | @moong/nuxt</title>
      ...
      <div class="col-content">
        <div class="tsd-page-title">
          <ul class="tsd-breadcrumb">
            ...
            <li>
              <a href="module_build_plugins_watch_node_modules.html"
                >module/build/plugins/watch-node-modules</a
              >
            </li>
          </ul>
          <h1>Module module/build/plugins/watch-node-modules</h1>
        </div>
        <aside class="tsd-sources">
          <ul>
            <li>
              Defined in
              <a
                href="https://github.com/dvmoomoodv/moong.framework/blob/5307b6688/framework/nuxt/src/module/build/plugins/watch-node-modules.ts#L1"
                >framework/nuxt/src/module/build/plugins/watch-node-modules.ts:1</a
              >
            </li>
          </ul>
        </aside>
          ...
          <section class="tsd-panel tsd-index-panel">
            ...
            <section class="tsd-index-section">
              ...
              <div class="tsd-index-list">
                <a
                  href="../variables/module_build_plugins_watch_node_modules.default.html"
                  class="tsd-index-link"
                  ><svg class="tsd-kind-icon" viewBox="0 0 24 24">
                    <use href="../assets/icons.svg#icon-32"></use></svg
                  ><span>default</span></a
                >
              </div>
            </section>
