        ...
        <UFieldSet>
          ...
          <UFieldRow>
            ...
            <UField label="I/F 버젼" totalWidth="400">
              <VTextField v-model="searchActions.criteria.ifVer" />
            </UField>
          ...
          <UFieldRow>
            <UField label="I/F 명" totalWidth="400">
              <VTextField v-model="searchActions.criteria.ifNm" />
            </UField>
            <UField label="url" totalWidth="400">
              <VTextField v-model="searchActions.criteria.url" />
            </UField>
            <UButtonBox right top>
              <VBtn text="신규" :width="80" @click="formActions.newIfs" />
              <VBtn text="검색" :width="80" @click="search" />
            </UButtonBox>
          </UFieldRow>
        </UFieldSet>
      </UButtonBar>
