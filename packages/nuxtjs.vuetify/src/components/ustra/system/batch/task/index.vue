          ...
          <UFieldSet>
            ...
            <UFieldRow>
              <UField label="입력 정보" v-if="formAction.mode.value === 'update'">
                <b
                  >{{ $ustra.utils.formatting.datetime(formAction.inputData.regDttm, 'yyyy-MM-dd hh:mm:ss') }} / {{ formAction.inputData.regUsrId }} /
            ...
            <UFieldRow>
              <UField label="수정 정보" v-if="formAction.mode.value === 'update'">
                <b
                  >{{ $ustra.utils.formatting.datetime(formAction.inputData.updDttm, 'yyyy-MM-dd hh:mm:ss') }} / {{ formAction.inputData.updUsrId }} /
