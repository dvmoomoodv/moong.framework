  ...
  <UBox direction="col">
    ...
    <UItem>
      <UButtonBox :right="true">
        <VBtn text="PNG" class="btn btn-default" prepend-icon="mdi-file-png-box" v-on:click="chartAction.exportChart('png')" />
        <VBtn text="JPEG" class="btn btn-default" prepend-icon="mdi-file-jpg-box" v-on:click="chartAction.exportChart('jpeg')" />
        <VBtn text="SVG" class="btn btn-default" prepend-icon="mdi-svg" v-on:click="chartAction.exportChart('svg')" />
      </UButtonBox>
