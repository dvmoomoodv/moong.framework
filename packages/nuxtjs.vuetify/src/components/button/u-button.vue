<template>
  <template v-if="!String(icon).includes('mdi')">
    <button v-bind="$attrs" class="u-button" type="button" :class="classes" :style="buttonStyles">{{ text }}</button>
  </template>
  <template v-if="String(icon).includes('mdi')">
    <button v-bind="$attrs" class="u-button" type="button" :class="classes" :style="buttonStyles">
