<template>
  ...
  <div v-if="mode === 'year'">
    {{ displayValue }}
    <v-combobox class="u-date-box-combo"
...
const updateDisplayValue = (dateValue: Date) => {
  ...
  useLogger().debug('$ustra.utils.date.format(dateValue.value as Date, displayFormat)', formatted)
  // displayValue.value
...
const updateModelValue = (dateValue: Date) => {
  ...
  useLogger().debug('$ustra.utils.date.format(dateValue.value as Date, valueFormat)', formatted)
  // displayValue.value
...
const displayValueUpdated = () => {
  ...
  try {
    dateValue.value = $ustra.utils.date.parse(displayValue.value, formats.value.value())
  } catch(e) {}
}
