...
const attrs = computed(() => {
  ...
  $attrs.closeOnContentClick = $ustra.utils.core.defaults(
    $attrs.closeOnContentClick,
    false
  );
  $attrs.noClickAnimation = $ustra.utils.core.defaults(
    $attrs.noClickAnimation,
    true
  );
  $attrs.transition = $ustra.utils.core.defaults(
    $attrs.transition,
