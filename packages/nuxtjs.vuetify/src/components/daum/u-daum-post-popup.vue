...
import { ref, withDefaults, defineEmits, defineProps } from "#moong/nuxt";
...
export const useDaumPostPopup = (options: {
  ...
  function getLoadScripts() {
    ...
    if (options.props.addLatLng) {
      scripts.push({
        key: "kakaoMapScript",
        src: `//dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=${options.props.apiKey}&libraries=services`,
      });
    }
