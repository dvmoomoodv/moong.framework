<template>
  <VCard>
    ...
    <template #text>
      UValidationGroup의 wrapContainer 속성은 boolean 형이며, div 태그 기반의
      container element를 렌더링할지 여부를 선택한다. 기본 값은 ture이며,
      false를 설정할 경우 Root Element를 생성하지 않아 Element의 구조를 유지할
      수 있다. <br /><br />
