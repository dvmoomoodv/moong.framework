...
<script lang="ts" setup>
  import { ref, shallowRef, defineExpose } from "#moong/nuxt";
  import { watchValidationData } from "#moong/nuxt-wijmo/composables/validation";
  ...
  defineExpose({
    validate: () => {
      ...
      const els = [];
      root.value
        .querySelectorAll(".wj-input-group")
        .forEach((i) => els.push(i));
