<template>
  <div>
    ...
    <v-card>
      ...
      <template #subtitle>
        UDateBox 컴포넌트를 사용하여 일자 입력을 처리할 수 있다.
      </template>
      <template #text>
    ...
    <v-card>
      ...
      <template #subtitle>
        mode로 컴포넌트의 입력 형태를 제어할 수 있다. 따로 지정 해 주지 않으면
        기본값은 'date' mode 이다.
      </template>
      <template #text>
        <div class="samplebox">
    ...
    <v-card>
      ...
      <template #subtitle>
        displayFormat으로 날짜 표시 포맷을 지정하고, valueFormat로 저장 될
        날짜의 포맷을 변경 할 수 있다.
      </template>
      <template #text>
        <div class="samplebox">
    ...
    <v-card>
      ...
      <template #subtitle>
        컴포넌트를 비활성화한다. 지정 해 주지 않으면 기본값은 false이다.
      </template>
      <template #text>
    ...
    <v-card>
      ...
      <template #subtitle>
        true로 지정 시, 바인딩 된 데이터가 null인 경우에 한하여 현재 시각으로
        초기화된다. <br />
