<template>
  <VCard>
    <template #text>
      ...
      <br />
      useSourceEditing 속성을 true로 설정하면 HTML 소스를 수정할 수 있는 툴바
      아이콘이 생성되며 HTML 소스를 직접 변경할 수 있다.
      <br /><br />
      ...
      <div class="mb-2">
        <VBtn
          @click="
            () =>
              $ustra.dom.window.alert(
                ckEditor.sourceEditing.isEditingMode.value
              )
          "
          >소스에디팅 여부 확인</VBtn
        >
...
import { ref, computed } from "#moong/nuxt";
