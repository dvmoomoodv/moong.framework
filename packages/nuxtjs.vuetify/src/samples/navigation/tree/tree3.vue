<template>
  <VCard>
    <template #text>
      ...
      showCheckboxes 속성을 true로 설정할 경우, tree 노드를 체크박스 형태로
      선택할 수 있으며, useWjTreeCheckedItems 메소드를 사용하여 체크된 노드의
      아이템을 확인할 수 있다.
...
import { useWjTreeCheckedItems } from "#moong/nuxt-wijmo/composables";
