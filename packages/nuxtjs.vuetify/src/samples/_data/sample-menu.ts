...
export default [
  {
    ...
    items: [
      ...
      },
      {
        ...
        visible: true,
        items: [
          { title: "v-focus", path: "common/vuetify-style", updated: false },
        ],
      },
      {
        title: "Composables",
        ...
        items: [
          {
            title: "useOnError",
            path: "common/composables/use-on-error",
            updated: false,
          },
        ],
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "반응형 레이아웃 설정",
        path: "layout/responsive-setting",
        updated: false,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: "CkEditor5",
        path: "input/ckeditor5",
        updated: false,
        visible: (appProps) => appProps.nuxt.ckeditor5.enabled,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        path: "miscellaneous/daum-post",
        updated: false,
      },
      {
        title: "QR-code",
        icon: "mdi-note-search-outline",
        path: "miscellaneous/qrcode",
        updated: false,
      },
    ],
  },
