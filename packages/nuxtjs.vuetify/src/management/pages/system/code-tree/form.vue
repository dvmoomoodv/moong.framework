<template>
  <UPopup v-model="model" :width="500" :height="600" title="코드 입력111">
    <UBox direction="col">
          ...
          <UFieldSet>
            ...
            <UFieldRow>
              <UField label="코드명" :required="true" :labelWidth="100">
                <VTextField v-model="inputFormData.cdNm" :initialized="e => isEditMode && e.focus()"></VTextField>
              </UField>
            </UFieldRow>

            <UFieldRow v-if="props.depth > 0">
              <UField label="정렬순번" :required="true" :labelWidth="100">
                <VTextField v-model="inputFormData.srtNo"></VTextField>
              </UField>
            </UFieldRow>
            ...
            <UFieldRow>
              <UField label="코드 설명" :labelWidth="100">
                <VTextField v-model="inputFormData.cdDesc" type="textarea"></VTextField>
              </UField>
            </UFieldRow>

            <UFieldRow>
              <UField label="기타필드1" :labelWidth="100">
                <VTextField v-model="inputFormData.etc1" :isRequired="false"></VTextField>
              </UField>
            </UFieldRow>

            <UFieldRow>
              <UField label="기타필드2" :labelWidth="100">
                <VTextField v-model="inputFormData.etc2" :isRequired="false"></VTextField>
              </UField>
            </UFieldRow>

            <UFieldRow>
              <UField label="기타필드3" :labelWidth="100">
                <VTextField v-model="inputFormData.etc3" :isRequired="false"></VTextField>
              </UField>
            </UFieldRow>

            <UFieldRow>
              <UField label="기타필드4" :labelWidth="100">
                <VTextField v-model="inputFormData.etc4" :isRequired="false"></VTextField>
              </UField>
            </UFieldRow>

            <UFieldRow>
              <UField label="기타필드5" :labelWidth="100">
                <VTextField v-model="inputFormData.etc5" :isRequired="false"></VTextField>
              </UField>
            </UFieldRow>
          </UFieldSet>
      </UItem>
      <UItem>
        <UButtonBox right top>
          ...
          <VBtn text="삭제" v-if="isEditMode" :width="80" @click="remove" />
        </UButtonBox>
      </UItem>
    </UBox>
  </UPopup>
