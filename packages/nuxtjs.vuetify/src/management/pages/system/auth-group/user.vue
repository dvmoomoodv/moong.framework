    ...
    <UFieldRow>
      <UButtonBar class="mt-2">
        <UButtonBox right>
          ...
          <VBtn
            icon="mdi-minus"
            :disabled="gridAction.dataProvider.rowCount < 1"
          ></VBtn>
        </UButtonBox>
      </UButtonBar>
    </UFieldRow>
...
import { ref, defineProps, watch } from "#moong/nuxt";
import {
  useUstraCodeValue,
  useUstraUserDeptName,
  User,
} from "#moong/nuxt/management";
import UserPopup from "#moong/nuxt-vuetify/management/components/popup/u-v-user-popup.vue";
