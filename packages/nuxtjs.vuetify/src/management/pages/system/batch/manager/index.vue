    ...
    <UItem>
      <UFieldSet>
        <UFieldRow :ratio="[1, 3]">
          ...
          <UField blank>
            <UButtonBox>
              <VBtn class="gray ico_reset" @click="searchAction.clearSearchParam"><span class="blind">초기화</span></VBtn>
      ...
      <UBox direction="row" style="gap: 5px">
        ...
        <UItem :ratio="5" :disabled="formAction.formDisabled.value">
          <UFieldSet>
            ...
            <UFieldRow>
              <UField label="엔드포인트"><VTextField type="textarea" noResize :isRequired="false" v-model="formAction.inputData.endpoint" /> </UField>
            </UFieldRow>
            <UFieldRow>
              <UField label="마스터 여부" required
                ><UVRadioGroupBox v-model="formAction.inputData.master" :itemsSource="searchAction.masterList" />
              </UField>
            </UFieldRow>
            <UFieldRow>
