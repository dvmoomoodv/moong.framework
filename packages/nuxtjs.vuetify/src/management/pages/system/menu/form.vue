          ...
          <UBox direction="col">
            <UItem :ratio="1">
              <UFieldSet ref="fieldSet">
                <UFieldRow v-if="!!uprMenuData">
                  <UField label="상위 메뉴 명">
                    <VTextField
                      :value="uprMenuData.pathText"
                      v-byte-length="20"
                      :readonly="true"
                    />
                  </UField>
                ...
                <UFieldRow>
                  <UField label="메뉴 유형" :width="150">
                    <UVCodeComboBox
                      grpCd="MNU_TY_CD"
                      v-model="inputData.mnuTyCd"
                    />
                  </UField>
                  <UField label="권한 범위" :width="150">
                    <UVCodeComboBox
                      grpCd="AUTH_SCOP_CD"
                      v-model="inputData.authScopCd"
                    />
                  </UField>
                </UFieldRow>
                <UFieldRow>
                ...
                <UFieldRow v-show="inputData.mnuTyCd === '02'">
                  <UField label=""> menufunctionform </UField>
                </UFieldRow>
                <UFieldRow>
                  <UField label="메뉴 아이콘">
          ...
          <UBox direction="col">
            <UItem :ratio="1">
              <UBox direction="col">
                ...
                <UItem :ratio="1">
                  <URealGrid
                    :columns="groupGrid.columns.value"
            ...
            <UItem :ratio="1">
              <UBox direction="col">
                ...
                <UItem :ratio="1">
                  <URealGrid
                    :columns="userGrid.columns.value"
...
import { Menu, MenuPathText } from "#moong/nuxt/management/models/menu";
...
import { computed, reactive, ref, shallowRef, defineExpose } from "#moong/nuxt";
