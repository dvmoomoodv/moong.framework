                            ...
                            <UFieldSet ref="fieldSet">
                                <UFieldRow v-if="!!uprMenuData">
                                    <UField label="상위 메뉴 명">
                                        <VTextField :value="uprMenuData.pathText" v-byte-length="20" :readonly="true" />
                                    </UField>
                                </UFieldRow>
                                <UFieldRow>
                                    <UField v-show="mode === 'update'" label="메뉴 ID">
                                        <VTextField :value="inputData.mnuId" v-byte-length="20" :readonly="true" />
                                    </UField>
                                </UFieldRow>
                                <UFieldRow>
                                ...
                                <UFieldRow>
                                    <UField label=" ">
                                        <VRow>
                                            <VCol cols="3">
                                                <VCheckbox v-model="inputData.dpYn" label="메뉴 노출" trueValue="Y" falseValue="N" />
                                            </VCol>
                                            <VCol cols="5">
                                                <VCheckbox v-model="inputData.prvViewYn" label="개인정보 조회 기능 포함" trueValue="Y" falseValue="N" />
                                            </VCol>
                                            <VCol cols="4">
                                                <VCheckbox v-model="inputData.ipLmtYn" label="아이피 제한" trueValue="Y" falseValue="N" />
                                            </VCol>
                                        </VRow>
                                    </UField>
                                </UFieldRow>
...
import { Menu, MenuPathText } from '#ustra/nuxt/management/models/menu'
